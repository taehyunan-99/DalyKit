...
| 2 | `problem` | 문제 정의 | 배경, 목적, 해결하려는 질문 | `harnessda/config/report_config.md` (핵심) |
...
| 8 | `stat_results` | 분석 결과 | 가설 검정 요약 테이블 | `harnessda/docs/stat_report.md` §4 |
| 9 | `key_findings` | 핵심 발견 | 효과 크기 상위 3개 + 실질적 해석 | `harnessda/docs/stat_report.md` §5 |
...
- 없으면: `harnessda/docs/eda_report.md` "분석 목적" 또는 `harnessda/docs/stat_report.md` "연구 개요"에서 추론
- **필수 요소**: "왜?" → "무엇을?" → "어떻게?"
...
### stat_results
- `harnessda/docs/stat_report.md` §4 요약 테이블 그대로 사용
